...
parser.add_argument('--path', type=str, default='D:/Study/dataset/flow_celeba', help='path to the dataset')
...
parser.add_argument('--output', type=str, default='C:/Users/ZhangNaner/Desktop/recur/datasets/structure', help='path to the three file lists')
