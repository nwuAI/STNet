...
def load_config(mode=None):
    ...
    # test mode
    if mode == 2:
        parser.add_argument('--input', type=str, default='C:/Users/ZhangNaner/Desktop/recur/examples/structure/images', help='path to the input images directory or an input image')
        parser.add_argument('--structure', type=str, default='C:/Users/ZhangNaner/Desktop/recur/examples/structure/stru', help='path to the input images directory or an input image')
        parser.add_argument('--mask', type=str, default='C:/Users/ZhangNaner/Desktop/recur/examples/structure/masks', help='path to the masks directory or a mask file')
        parser.add_argument('--edge', type=str, help='path to the edges directory or an edge file')
        parser.add_argument('--output', type=str, default='C:/Users/ZhangNaner/Desktop/recur/checkpoints/results', help='path to the output directory')
    ...
    # test mode
        ...
        if args.structure is not None:
            config.TEST_STRUCTURE_FLIST = args.structure
